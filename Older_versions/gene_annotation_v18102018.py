...
def overlap_ENSEMBLE(bed_record):
    ...
    request = requests.get(SERVER+SPECIES+"/"+CHROM+":"+SV_START+"-"+SV_END+"?feature=gene", headers=HEADERS)
...
KNOWN_GENES="/home/cog/sdeblank/Documents/sharc/genes.json"
...
with open(VCF_OUT, "r") as vcf:
    ...
    #         if GO_TERM=="nucleus":
    #              count += 1
    print ("JA: ",count1,"Wel gen, geen overlap: ",count2, "Geen gen: ", count3)
